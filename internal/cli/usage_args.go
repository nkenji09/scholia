...
var stringFlagSpecs = map[string]argSpec{
	...
	"scholia decide --refs":                  {class: classFreeText},
	"scholia decision edit --base":           {class: classFreeText},
	"scholia decision edit --changed":        {class: classFreeText},
	"scholia decision edit --ref":            {class: classFreeText},
	"scholia decision edit --why":            {class: classFreeText},
	"scholia decision rm --base":             {class: classFreeText},
...
var positionalSpecs = map[string]positionalSpec{
	...
	// 2 つ目以降は URL・issue 番号・チケット id の並び（cobra.MinimumNArgs(2)）。
	"scholia decision add-ref":        {at: []argSpec{{class: classRecordID, selector: selDecision}, {class: classFreeText}}, variadic: true},
	"scholia decision edit":           {at: []argSpec{{class: classRecordID, selector: selDecision}}},
	"scholia decision rm":             {at: []argSpec{{class: classRecordID, selector: selDecision}}},
