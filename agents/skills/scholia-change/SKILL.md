...
- adopt 前に、**合意の重さ**に応じた対話（重い＝1項目ずつ変更前/変更後/観測例/トレードオフ/推奨・軽い＝
  サマリー＋Adopt）を経ている。
- 重い項目は、**変更後の文だけ**を書き手以外の読み手（別セッション／人）へ渡して「どう読めるか」を訊き、
